...
import com.bookstore.ui.inventory_menu.JFrameDaftarPo;
import com.bookstore.ui.inventory_menu.JFrameBuatPurchaseOrder;
import com.bookstore.ui.inventory_menu.JFrameKonfigurasiRak;
import com.bookstore.ui.inventory_menu.JFrameTerimaPurchaseOrder;
import com.bookstore.ui.inventory_menu.JFrameStokBuku;
 ...
 * @author rifki
 */
public class JFrameGudang extends javax.swing.JFrame {
    /**
    ...
    public JFrameGudang() {
        ...
        addWindowListener(new WindowAdapter() {
            ...
            public void windowClosing(WindowEvent e) {
                int option = JOptionPane.showConfirmDialog(JFrameGudang.this,
                        "Apakah Kamu Yakin Ingin Keluar Dari Aplikasi?",
                        "Konfirmasi Keluar", JOptionPane.YES_NO_OPTION);
                if(option == JOptionPane.YES_OPTION){
                    JFrameGudang.this.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
                    JFrameGudang.this.setVisible(false);
    ...
    private void DaftarStockBukuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DaftarStockBukuActionPerformed
        JFrameStokBuku stockBook = new JFrameStokBuku(this);
    ...
    private void RackConfigActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RackConfigActionPerformed
        JFrameKonfigurasiRak rakConfig = new JFrameKonfigurasiRak(this);
    ...
    private void CreatePOMenuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CreatePOMenuActionPerformed
        JFrameBuatPurchaseOrder poManagement = new JFrameBuatPurchaseOrder(this);
    ...
    private void CheckPOMenuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CheckPOMenuActionPerformed
        JFrameDaftarPo daftarPO = new JFrameDaftarPo(this);
    ...
    private void receivedPOMenuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_receivedPOMenuActionPerformed
        JFrameTerimaPurchaseOrder receivedPurchaseOrder = new JFrameTerimaPurchaseOrder(this);
