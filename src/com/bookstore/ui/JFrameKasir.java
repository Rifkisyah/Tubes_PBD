 ...
 * @author rifki
 */
public class JFrameKasir extends javax.swing.JFrame {
    /**
    ...
    public JFrameKasir() {
        ...
        addWindowListener(new WindowAdapter() {
            ...
            public void windowClosing(WindowEvent e) {
                int option = JOptionPane.showConfirmDialog(JFrameKasir.this,
                        "Apakah Kamu Yakin Ingin Keluar Dari Aplikasi?",
                        "Konfirmasi Keluar", JOptionPane.YES_NO_OPTION);
                if(option == JOptionPane.YES_OPTION){
                    JFrameKasir.this.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
                    JFrameKasir.this.setVisible(false);
