...
import com.bookstore.ui.administrator_menu.JFrameKonfigurasiVendor;
import com.bookstore.ui.inventory_menu.JFrameGantiPassword;
import com.bookstore.ui.administrator_menu.JFrameMaintenancePegawai;
import com.bookstore.ui.administrator_menu.JFrameMaintenanceRolePegawai;
...
public class JFrameAdmin extends javax.swing.JFrame {
    ...
    public JFrameAdmin() {
        ...
        addWindowListener(new WindowAdapter() {
            ...
            public void windowClosing(WindowEvent e) {
                int option = JOptionPane.showConfirmDialog(JFrameAdmin.this,
                        "Apakah Kamu Yakin Ingin Keluar Dari Aplikasi?",
                        "Konfirmasi Keluar", JOptionPane.YES_NO_OPTION);
                if(option == JOptionPane.YES_OPTION){
                    JFrameAdmin.this.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
                    JFrameLogin loginFrame = new JFrameLogin();
                    JFrameAdmin.this.setVisible(false);
    ...
    private void ChangePasswordActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChangePasswordActionPerformed
        JFrameGantiPassword changePassword = new JFrameGantiPassword();
    ...
    private void MaintenanceRolePegawaiMenuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MaintenanceRolePegawaiMenuActionPerformed
        JFrameMaintenanceRolePegawai maintenanceRolePegawai = new JFrameMaintenanceRolePegawai(this);
    ...
    private void configVendorMenuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_configVendorMenuActionPerformed
        JFrameKonfigurasiVendor configVendor = new JFrameKonfigurasiVendor(this);
    ...
    private void MaintenancePegawaiMenuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MaintenancePegawaiMenuActionPerformed
        JFrameMaintenancePegawai maintenancePegawai = new JFrameMaintenancePegawai(this);
